    ...
    def forward(
        ...
        if warmup >= 0.0:
            ...
            if self.attention_decoder is not None:
              sos_id = self.attention_decoder.sos_id
              eos_id = self.attention_decoder.eos_id
              attention_loss = self.attention_decoder(
        ...
        return (simple_loss, pruned_loss, ctc_loss, attention_loss)
